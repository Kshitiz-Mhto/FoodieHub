package com.example.foodapp.modal.foodbycategory.seafood
...
class SeafoodRecyclerViewAdaptor(val seafoodList: List<Meal>?, val context: Context) : RecyclerView.Adapter<MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        var index_element = seafoodList!![position]
