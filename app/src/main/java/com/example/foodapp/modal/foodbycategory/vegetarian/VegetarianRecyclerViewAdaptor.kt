package com.example.foodapp.modal.foodbycategory.vegetarian
...
class VegetarianRecyclerViewAdaptor(val vegetarianList: List<Meal>?, val context: Context) : RecyclerView.Adapter<MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        var index_element = vegetarianList!![position]
