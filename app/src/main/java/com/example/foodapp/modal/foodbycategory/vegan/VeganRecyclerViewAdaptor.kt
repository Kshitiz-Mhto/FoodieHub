package com.example.foodapp.modal.foodbycategory.vegan
...
class VeganRecyclerViewAdaptor(val veganList: List<Meal>?, val context:Context) : RecyclerView.Adapter<MyViewHolder>() {
    ...
    override fun getItemCount(): Int {
        return veganList!!.size
    }

    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        var index_element = veganList!![position]
