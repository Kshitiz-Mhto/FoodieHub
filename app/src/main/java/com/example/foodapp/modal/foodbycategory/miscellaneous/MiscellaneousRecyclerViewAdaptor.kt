package com.example.foodapp.modal.foodbycategory.miscellaneous
...
class MiscellaneousRecyclerViewAdaptor(val miscellList: List<Meal>?, val context: Context) : RecyclerView.Adapter<MyViewHolder>() {
    ...
    override fun getItemCount(): Int {
        return miscellList!!.size
    }

    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        var index_element = miscellList!![position]
