package com.example.foodapp.modal.foodbycategory.Goat
...
class GoatRecyclerViewAdaptor(val goatList: List<Meal>?, val context: Context) : RecyclerView.Adapter<MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        var index_element = goatList!![position]
