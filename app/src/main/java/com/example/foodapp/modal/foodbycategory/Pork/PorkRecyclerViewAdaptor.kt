package com.example.foodapp.modal.foodbycategory.Pork
...
class PorkRecyclerViewAdaptor(val porkList: List<Meal>?, val context: Context) : RecyclerView.Adapter<MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        var index_element = porkList!![position]
